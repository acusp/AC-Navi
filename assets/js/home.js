...
if (Cookies.get('qidian_navi_previous_search_service_option') === undefined || Cookies.get('qidian_navi_previous_search_service_option') === '' || $('#' + Cookies.get('qidian_navi_previous_search_service_option')).length === 0) {
    Cookies.set('qidian_navi_previous_search_service_option', $('#search-services').val(), { expires: 365 });
} else {
    $('#search-services').dropdown('set selected', Cookies.get('qidian_navi_previous_search_service_option'));
}
...
$('#search-button').click(function () {
    ...
    if (query) {
        Cookies.set('qidian_navi_previous_search_service_option', service.val(), { expires: 365 });
